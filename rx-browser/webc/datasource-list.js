...
import { datasourceChangeEvt, } from "./datasource-events";
...
class DatasourceList extends TWElement {
    ...
    async firstUpdated() {
        ...
        hasFlag("DSTabsPagination").then((hasFlag) => {
          ...
          <div class="mb-14 w-fit flex overflow-hidden rounded">
            ${this.tabsCaptions.map((v, i) => html `<button
                  class="${i == 0
    ...
    render() {
      ...
      <div class="p-14 dark:bg-neutral-900 mb-8">
        ...
        <div class="relative">
          ${map(range(this.tabsCaptions.length), (i) => html `<slot name="tab${i}"></slot>`)}
        </div>
...
//# sourceMappingURL=datasource-list.js.map